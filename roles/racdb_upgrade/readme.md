...
```To execute:You can do based on your requirement
To upgrade:  enable roles racdb_preupgrade and racdb_upgrade | disable roles racdb_predwngrade and racdb_dwngrade
To downgrade: racdb_predwngrade and racdb_dwngrade enable roles  | disable roles racdb_preupgrade and racdb_upgrade 
```
 ``` 
[root@oel75 ansible]# cat oracledbupgdwn.yml
...
ansible-playbook oracledbupgdwn.yml  
